...
class IntelligenceExtractor:
    ...
    def _extract_organization_intelligence(self, raw_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        intelligence = {
            ...
            "company_background": self._extract_section(content, "Company Background", "Leadership Intelligence"),
            "leadership_intelligence": self._extract_leadership_intelligence(content),
            "financial_information": self._extract_financial_information(content),
            "news_intelligence": self._extract_news_intelligence(content),
            "challenges_risks": self._extract_challenges_risks(content),
            "strategic_priorities": self._extract_section(content, "Strategic Priorities", "Recent Activity"),
            "recent_activity": self._extract_section(content, "Recent Activity", "Additional Sources"),
            "additional_sources_info": self._extract_section(content, "Additional Sources Information", None),
            "sources": raw_data.get("sources", []),
            "raw_content": content
        }
