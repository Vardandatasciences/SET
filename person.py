    ...
    async def _parse_experience_item(self, item):
        ...
        try:
            ...
            for text in texts:
                ...
                if any(skip in text_lower for skip in ['linkedin', 'view', 'more', 'show', 'hide']):
                    continue
            ...
            if len(unique_texts) >= 2:
                ...
                position_title = unique_texts[0] if len(unique_texts[0]) > 3 else None
                company_name = unique_texts[1] if len(unique_texts[1]) > 3 else None
                ...
                # Might be just position or company
                position_title = unique_texts[0] if len(unique_texts[0]) > 3 else None
